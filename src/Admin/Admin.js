...
function Admin() {
  ...
  const addPost = (e) => {
    ...
    stateButton === "Add"
      ? axios
          .post(`https://61bc10bcd8542f001782451a.mockapi.io/Itemofcart`, {
            status: post.status,
      ...
      : axios
          .put(
            `https://61bc10bcd8542f001782451a.mockapi.io/Itemofcart/${post.id}`,
            {
              id: post.id,
              status: post.status,
              image_post: post.image_post,
  ...
  const deleteProduct = (product) => {
          ...
          axios
            .delete(
              `https://61bc10bcd8542f001782451a.mockapi.io/Itemofcart/${product.id}`
            )
            .then((res) => {
              getData();
            });
